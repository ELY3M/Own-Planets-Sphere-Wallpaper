...
public class WallpaperSettings extends PreferenceActivity implements OnSharedPreferenceChangeListener, OnPreferenceClickListener {
    ...
    private Preference planetnum;
    private Preference planetnum2;
    ...
    protected void onCreate(Bundle icicle) {
        ...
        this.planetnum = findPreference("planetnum");
        this.planetnum.setOnPreferenceClickListener(this);
        this.planetnum2 = findPreference("planetnum2");
        this.planetnum2.setOnPreferenceClickListener(this);
    ...
    public boolean onPreferenceClick(Preference key) {
        ...
        //planet 1 numbers
        if (key == this.planetnum) {
            new DiamondNumberDialog(this.context, null, 0).show();
        }

        //planet 2 numbers
        if (key == this.planetnum2) {
            new DiamondNumberSecondDialog(this.context, null, 0).show();
        }
